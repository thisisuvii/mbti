  ...
  return (
    <div className="min-h-screen bg-yellow-50 flex flex-col justify-center items-center">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col items-center space-y-4">
        ...
        />
        <button type="submit" className="px-6 py-2 rounded-lg bg-primary text-pink font-medium shadow-md hover:bg-blue-700 transition-colors duration-300 focus:outline-pink focus:ring-2 focus:ring-primary">
          결과 보기
        </button>
      </form>
      {result && (
